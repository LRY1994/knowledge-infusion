...
class Seq2SeqModel:
    def __init__(
        ...
        encoder_decoder_name=None,# model_name_or_path
        config=None,
        args=None,
        use_cuda=True,
        cuda_device=-1,
        **kwargs,
        ...
        # 加载模型参数
        self.args = self._load_model_args(encoder_decoder_name)#model_name_or_path
    ...
    def _load_model_args(self, encoder_decoder_name):
        args = Seq2SeqArgs()
        args.load(encoder_decoder_name)
        return args
