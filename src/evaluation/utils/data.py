...
class MyQADataset(Dataset):
    def __init__(self,
                 ...
                 is_training=False):
        self.input_ids = torch.LongTensor(input_ids) #input_ids 由batch_encode_plus来的
        
        
        self.attention_mask = torch.LongTensor(attention_mask)
        self.decoder_input_ids = torch.LongTensor(decoder_input_ids)

        print(self.decoder_input_ids.shape)#torch.Size([96676, 36])
